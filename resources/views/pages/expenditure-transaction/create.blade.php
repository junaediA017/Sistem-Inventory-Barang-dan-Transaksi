...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active bg-white border p-2 px-3" id="home" role="tabpanel">
        <form action="{{ route('expenditure-transaction-items.store') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-10">
    ...
    <div class="tab-pane fade p-2 px-3 bg-white border" id="profile" role="tabpanel">
        <form class="row" action="{{ route('expenditure-transactions.store') }}" method="POST">
            @csrf
            @method('POST')
            ...
            <div class="col-md-6 col-lg-4">
                <div class="form-group">
                    <label for="picker">Merk</label>
                    <input type="text" class="form-control" id="picker" name="picker" value="{{ old('picker') }}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
