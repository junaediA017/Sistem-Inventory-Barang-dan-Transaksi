...
@section('content')
    ...
    <div class="row justify-content-end">
        <div class="col-auto">
            <a href="{{ route('expenditure-transactions.create') }}" class="btn btn-sm btn-primary mb-3" style="background-color: #ff0000";>
                        ...
                        @else
                            @foreach ($items as $item)
                                <tr>
                                    ...
                                    @can('isPemilik')
<td class="text-center align-middle">
    <form id="remarksForm" action="{{ route('expenditure-transactions.update', $item->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('expenditure-transactions.show', $item->id) }}" class="btn btn-secondary">
            Detail
        </a>
    </form>
</td>
